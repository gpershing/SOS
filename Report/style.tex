...
If the function is short, then it should be on the same line. Otherwise, the expression should start on the next line and be indented by four spaces.

\begin{lstlisting}
var : type = expr...
fxn : (arg1: type, arg2: type, ...) -> type = expr
fxn : (arg1: type, arg2: type, ...) -> type =
    long expr...\end{lstlisting}
...
function(args...)  // not function ( args ) \end{lstlisting}
